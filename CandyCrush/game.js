...
Main.prototype={
    ...
    createScore:function(){
        ...
        me.scoreLabel=me.game.add.bitmapText(75,150, 'myfont', '0', 32);
    ...
    createMoveCount:function(y){
        this.game.add.bitmapText(50,y-30, 'myfont', 'Moves Left:', 35);//this.game.add.text(50,y,"0",{font:scoreFont,fill:"#000"});
        this.moveLabel = this.game.add.bitmapText(50,y, 'myfont', '0', 35);//this.game.add.text(50,y,"0",{font:scoreFont,fill:"#000"});
