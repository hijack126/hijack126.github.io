(function() {
	...
	showStartGameUI=function()
	{
		 ...
		 ui_gameTitle.init(gameWidth*0.3,-assetsManager.gametitle.height,Infinity,assetsManager.gametitle,topContext);
		 TweenLite.to(ui_gameTitle.position,0.5,{y:gameHeight*0.3});
